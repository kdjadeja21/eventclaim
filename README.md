...
Web app for distributing Cursor credit coupons to event attendees: import attendees, grant the shared Cursor Credits link (or other partner offers), send claim emails, track claims, and audit admin activity.
