...
export function OfferPreviewDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="z-[60] max-h-[90vh] max-w-2xl overflow-y-auto border-0 bg-background p-0 sm:rounded-lg">
        {offer && (
          <div className="relative overflow-hidden">
            ...
            <div className="relative z-10 px-6 pb-8 pt-6">
              ...
              <p className="mb-6 text-sm text-muted-foreground">
                ...
                all credits and promo codes are limited in quantity and offered
                on a first-come, first-served basis. Redeem early to avoid
                missing out.
              </p>
