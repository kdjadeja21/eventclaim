...
> = {
  ...
  registrations_luma_synced: "info",
  teams_auto_built: "info",
  team_created: "success",
  team_updated: "info",
  team_deleted: "destructive",
  team_member_assigned: "success",
  team_member_removed: "warning",
  teams_data_cleared: "destructive",
  team_link_confirmed: "success",
  team_link_rejected: "warning",
  team_registration_pooled: "info",
...
const actionLabels: Record<AuditAction, string> = {
  ...
  registrations_luma_synced: "Registrations Synced",
  teams_auto_built: "Teams Auto-Built",
  team_created: "Team Created",
  team_updated: "Team Updated",
  team_deleted: "Team Deleted",
  team_member_assigned: "Member Assigned",
  team_member_removed: "Member Removed",
  teams_data_cleared: "Teams Data Cleared",
  team_link_confirmed: "Fuzzy Link Confirmed",
  team_link_rejected: "Fuzzy Link Rejected",
  team_registration_pooled: "Moved to Pool",
